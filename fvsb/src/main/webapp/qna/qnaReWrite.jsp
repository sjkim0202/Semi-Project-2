...
String ref = request.getParameter("q_ref");
String lev = request.getParameter("q_lev");
String step = request.getParameter("q_step");
		...
		<section>
			...
			<article>
				<form name="qnaReWrite" action="qnaReWrite_ok.jsp" method="post">
					<input type="hidden" name="q_ref" value="<%=ref%>"> <input
						type="hidden" name="q_lev" value="<%=lev%>"> <input
						type="hidden" name="q_step" value="<%=step%>">
					<table>
						<tr>
							<th colspan="2">작성자</th>
						...
						<tr>
							...
							<td colspan="3" align="center"><input type="text"
								name="q_title" value="답변 :  <%=title%>" class="titletext"
								readonly></td>
						</tr>
						<tr>
